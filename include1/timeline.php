<div class="left">
    <div class="box">
        <h2>Intro</h2>
        <div class="intro">
            <p>Persuing Masters in Computer Application</p>
            <p>Studies at Banasthali University</p>
            <p>Went to Priyanka modern school</p>
            <p>From Dhampur, BIJNOR</p>
    ...
    <div class="box ">
        <div class="row">
            <div class="send-post">
                ...
                <input type="text" id="myBtn" placeholder="What's on your mind ?">
            </div>
        </div>
    </div>
    <div class="box">
