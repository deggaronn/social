    ...
    <div class="modal-content">
        ...
        <form action="" method="post" id="createpost" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="model-con">
                    <textarea style="height: 40px;" name="postcontent" id="postcontent"  placeholder="what's on your mind, <?php echo ucfirst($name) ?>"></textarea>
                </div>
                <div class="add-post">
                    <img style="width: 91%; margin-left: 8px; height: 140px;" id="add-image" src="" alt="">
                </div>
